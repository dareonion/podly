...
CI: `.github/workflows/android.yml` runs the build plus all unit tests on every push/PR to main. `recommendations.yml` regenerates the AI picks JSON daily and deploys it to GitHub Pages.
